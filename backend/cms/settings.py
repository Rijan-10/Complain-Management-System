...
SECRET_KEY = 'django-insecure-!+8y7wjw_1o@jwm9(0xb7kd^2)lvw(hj9czca*5g4!d=*atz^%'
...
MIDDLEWARE = [
    ...
    'main.middleware.NoStoreForAuthenticatedMiddleware',
    'main.middleware.Nice404Middleware',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR.parent / 'Frontend' / 'Users', BASE_DIR.parent / 'Frontend' / 'Admin'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
